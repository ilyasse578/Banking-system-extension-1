...
void PerformTranactionsMenuOption(enTransactionsMenuOptions TransactionMenuOption)
{
...
void ShowTransactionsMenu()
{
    ...
    cout << "\t[4] Main Menu.\n";
    cout << "===========================================\n";
    PerformTranactionsMenuOption((enTransactionsMenuOptions)ReadTransactionsMenuOption());
}
